  ...
  return (
    <nav className="sticky top-0 z-50 h-16 bg-white border-b border-black/10 px-7 flex items-center justify-between shadow-sm">
      ...
      <div className="flex gap-1">
        <button className="px-4 py-1.5 rounded-full text-xs font-extrabold uppercase tracking-wider text-[#6B5040] hover:bg-[#FAECE7] hover:text-[#D85A30] transition-all">
          Home
        </button>
        <button className="px-4 py-1.5 rounded-full text-xs font-extrabold uppercase tracking-wider text-[#6B5040] hover:bg-[#FAECE7] hover:text-[#D85A30] transition-all">
          Explore
      ...
      <div className="flex flex-col items-center justify-center w-13 h-13 rounded-full bg-[#D85A30] border-3 border-[#993C1D] shadow-lg cursor-pointer hover:scale-105 hover:-rotate-3 transition-transform">
        <span className="text-[10px] font-bold text-[#FFE8B0] leading-none">PANELI-</span>
        <span className="text-lg leading-none">🍳</span>
        <span className="text-[10px] font-bold text-[#FFE8B0] leading-none">NHAS</span>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <button className="px-5 py-1.5 rounded-full border-1.5 border-[#D85A30] text-[#D85A30] text-sm font-extrabold hover:bg-[#D85A30] hover:text-white transition-all">
          Login
        </button>
      </div>
