      ...
      <div className="w-full flex">
        ...
        <div className="flex-1 bg-white flex flex-col justify-center p-10">
          <div className="w-full max-w-sm mx-auto flex flex-col gap-4">
            ...
            {sucesso && (
              <div className="w-full px-4 py-3 rounded-lg text-sm font-medium text-center bg-green-500/10 border border-green-400/30 text-green-500">
                {sucesso}
              </div>
            )}
            ...
            <p className="text-sm text-gray-400 text-center">
              Já tem uma conta?{" "}
              <Link to="/login" className="text-[#D85A30] hover:underline font-semibold">
                Entrar
              </Link>
            </p>
